...
$Aktuality = new Aktuality($this->skript,$this->parametry,$this->get_parametry); 
$sablonka->pridejDoSablonky('{obsah}',$Aktuality->aktualityDetail(),'html');
...
echo $sablonka->generujSablonku('aktuality_detail'); 
...
$Aktuality = new Aktuality($this->skript,$this->parametry,$this->get_parametry); 
$sablonka->pridejDoSablonky('{obsah}',$Aktuality->aktualityVypis(),'html');


$produkty = new Produkty($this->skript,$this->parametry,$this->get_parametry,__TYP_CENY__);
$sablonka->pridejDoSablonky('{top_produkty}',$produkty->zobrazProduktyNovinky(),'html');
