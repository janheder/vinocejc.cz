...
class StringUtils
{
	...
	public static function removeAccents($text) {
		...
		$t_text = str_replace(' ','-',strtolower(strtr($text, $chars)));
		...
		$t_text = str_replace('->','',$t_text);
		$t_text = str_replace('/','',$t_text);
		$t_text = str_replace('α','',$t_text);
		$t_text = str_replace('µ','',$t_text);
		$t_text = str_replace('´','',$t_text);
		$t_text = str_replace(')','',$t_text);
		$t_text = str_replace('(','',$t_text);
		$t_text = str_replace(']','',$t_text);
